                            ...
                            <div class="mb-3">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current>Chi tiết giỏ hàng </li>
                                    </ol>
                                </nav>
                            </div>
                                        ...
                                        <div class="bg-light rounded">
                                            <div class="p-4">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <h5 class="mb-0 me-4">Phí thanh toán</h5>
                                                    <div>
                                                        <p class="mb-0">0 đ</p>
                                                    </div>
                                                </div>
                                                <div class="mt-3 d-flex justify-content-between">
                                                    ...
                                                    <div>
                                                        <p class="mb-0">Chuyển khoản:tên + sdt + khóa học</p>
                                                    </div>
                                                </div>
                                                <div
